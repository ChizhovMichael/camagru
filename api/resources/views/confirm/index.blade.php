            ...
            <div class="col-lg-6 mb-5 mb-lg-0 position-relative">
                ...
                <div class="card border border-light">
                    <div class="card-body px-4 py-5 px-md-5 text-center">
                        ...
                        <p class="text-muted">If you did not receive the message, please click the button below to retry your request.</p>
...
<script src="<?= $this->assets('js/confirm/index.js'); ?>"></script>
<?php $this->endsection(); ?>
